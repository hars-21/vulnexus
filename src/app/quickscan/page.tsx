...
export default function QuickscanPage() {
	return (
		<div className="flex flex-1 overflow-hidden text-slate-800 bg-slate-50">
			<style
			...
			/>
			<aside className="w-64 bg-white border-r border-slate-200 flex flex-col overflow-y-auto custom-scrollbar shrink-0">
				<nav className="flex-1 p-4 space-y-8">
					<div>
						<h3 className="text-xs font-semibold text-slate-400 tracking-wider uppercase mb-3 px-3">
							Main
						</h3>
						<ul className="space-y-1">
							<li>
								<Link
									className="block px-3 py-2 text-slate-600 hover:bg-slate-50 hover:text-slate-900 rounded-md text-sm"
									href="/"
								>
									Home
								</Link>
					...
					<div>
						...
						<ul className="space-y-1">
							...
							<li>
								<a
									className="block px-3 py-2 bg-blue-50 text-blue-700 font-medium rounded-md border-l-4 border-blue-700 text-sm"
									href="/quickscan"
								>
				...
				<div className="p-4 border-t border-slate-200 mt-auto">
					...
					<div className="space-y-4 px-3">
						<div className="flex justify-between items-start">
							<div>
								<p className="text-sm font-medium text-slate-800">auth-service-main</p>
								<p className="text-xs text-slate-500">2 hours ago</p>
							</div>
							<span className="text-xs font-medium text-red-500">4 Flaws</span>
						</div>
						<div className="flex justify-between items-start">
							<div>
								<p className="text-sm font-medium text-slate-800">payment-gateway-v2</p>
