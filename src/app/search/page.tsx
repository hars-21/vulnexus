				...
				<div className="flex flex-col min-w-0">
					<div className="mb-6">
						<h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100 mb-2">
							{query ? (
								<>
									Search Results for &lsquo;<span className="text-primary">{query}</span>&rsquo;
								</>
							) : (
								<>CVE Database</>
							)}
						...
						<p className="text-slate-500 dark:text-slate-400 text-sm">
							{query ? "About 342 results found (0.24 seconds)" : "Browse all vulnerabilities"}
						</p>
					</div>
					<div className="border-b border-slate-200 dark:border-slate-800 mb-8 overflow-x-auto">
						<div className="flex gap-8 whitespace-nowrap min-w-max">
							...
							<a
								...
								href="#"
							>
								<p className="text-sm font-bold leading-normal tracking-[0.015em]">Exploits (45)</p>
							</a>
							<a
								className="flex flex-col items-center justify-center border-b-2 border-transparent text-slate-500 dark:text-slate-400 pb-3 pt-2 hover:text-slate-900 dark:hover:text-slate-100"
								href="#"
							>
								<p className="text-sm font-bold leading-normal tracking-[0.015em]">Articles (87)</p>
							</a>
						</div>
					</div>
					<div className="space-y-10">
						<article className="flex flex-col gap-2">
							...
							<p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm line-clamp-3">
								An attacker can manipulate file upload parameters to enable path traversal and under
								some circumstances this can be used to upload a malicious file which can lead to
								Remote Code Execution (RCE). Affected versions of{" "}
							...
							<div className="flex gap-4 mt-1">
								<a
									...
									href="#"
								>
									<span className="material-symbols-outlined text-[14px]">link</span> Reference URL
								</a>
								<a
									className="text-xs font-semibold text-slate-500 hover:text-primary flex items-center gap-1"
									href="#"
						...
						<article className="flex flex-col gap-2">
							...
							<h3 className="text-xl font-semibold">
								<a className="text-primary hover:underline" href="#">
									Deep Dive: Understanding the <span className="hit-highlight">Apache Struts</span>{" "}
									OGNL Injection Chain
								</a>
							</h3>
							<p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm line-clamp-3">
								This technical analysis explores how{" "}
								<span className="hit-highlight">Apache Struts</span> handles Object-Graph Navigation
								Language (OGNL) expressions and why this component has historically been a frequent
								target for remote execution exploits. We examine the latest patches released in
								January 2024 for the 6.x branch.
							</p>
							<div className="flex gap-4 mt-1">
								<a
									className="text-xs font-semibold text-slate-500 hover:text-primary flex items-center gap-1"
						...
						<article className="flex flex-col gap-2">
							...
							<h3 className="text-xl font-semibold">
								<Link className="text-primary hover:underline" href="/cves/CVE-2021-31805">
									S2-062: <span className="hit-highlight">Apache Struts</span> 2.0.0 through 2.5.29
									Double Evaluation RCE
								</Link>
							</h3>
							<p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm line-clamp-3">
								Forced double evaluation occurs when{" "}
								<span className="hit-highlight">Apache Struts</span> 2 tag attributes are evaluated
								twice based on certain user-controlled inputs. An attacker could provide a malicious
								expression which, when evaluated the second time, leads to arbitrary code execution
								on the server.
							</p>
							<div className="flex gap-4 mt-1">
								<a
						...
						<article className="flex flex-col gap-2">
							...
							<p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm line-clamp-3">
								...
								<span className="hit-highlight">Apache Struts</span> where certain OGNL expressions
								could bypass the sandbox under specific configurations. This requires the
								&ldquo;struts.ognl.enableExpressionCache&rdquo; property to be set to false.
							</p>
						</article>
					</div>
