...
import { Database, Radio, Bot, Route, Zap, Github, Terminal, ArrowRight } from "lucide-react";
...
const features = [
	{
		...
		icon: Database,
		label: "CVE Search",
		desc: "Hybrid BM25 + semantic search across the NVD database.",
		color: "text-[#0646ac] bg-[#0646ac]/10",
	},
	{
		href: "/threat-feed",
		icon: Radio,
		label: "Threat Feed",
		desc: "Live stream of new CVEs filtered by severity and exploitability.",
		color: "text-red-500 bg-red-50",
	},
	{
		href: "/assistant",
		icon: Bot,
		label: "AI Pentester Assistant",
		desc: "RAG-powered AI that maps your targets to real CVEs and exploitation paths.",
		color: "text-purple-600 bg-purple-50",
	},
	{
		href: "/attack-path",
		icon: Route,
		label: "Attack Path Generator",
		desc: "Input services and get a full visualized attack chain with CVE mapping.",
	...
	},
	{
		...
		desc: "Paste raw nmap output — auto-extract services and generate attack graph.",
	...
	},
	{
		...
		desc: "Clone any repo and detect vulnerabilities with AI confidence scoring.",
		color: "text-green-600 bg-green-50",
	},
	{
		href: "/pocs",
		icon: Terminal,
		label: "Community POCs",
		desc: "Browse, submit, and vote on proof-of-concept exploits.",
