		...
		<div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 font-display">
			...
			<div className="flex flex-col h-[calc(100vh-8rem)] overflow-hidden">
				<div className="flex flex-1 overflow-hidden">
					<main className="flex-1 flex flex-col bg-white dark:bg-slate-900" id="chat-container">
						...
						<div className="flex-1 overflow-y-auto px-8 py-8 space-y-10 scrollbar-hide">
							<div className="max-w-3xl mx-auto flex gap-4">
								<div className="size-8 rounded bg-slate-100 dark:bg-slate-800 flex-shrink-0 flex items-center justify-center">
									<span className="material-symbols-outlined text-slate-500 text-sm">person</span>
								</div>
								<div className="flex-1 text-sm leading-relaxed">
									Analyze the attack surface for the recent Log4j vulnerability. I&apos;m
									specifically looking for common bypasses used against early mitigation attempts.
								</div>
							</div>
							<div className="max-w-3xl mx-auto flex gap-4">
								<div className="size-8 rounded bg-primary flex-shrink-0 flex items-center justify-center">
									<span className="material-symbols-outlined text-white text-sm">smart_toy</span>
								</div>
								<div className="flex-1 space-y-4">
									<p className="text-sm leading-relaxed">
										The initial mitigation for Log4Shell (CVE-2021-44228) focused on disabling
										lookup mechanism via system properties. However, several bypasses were
					...
					<aside
						className="w-72 flex-shrink-0 border-l border-primary/10 bg-white dark:bg-slate-900"
						id="context-sidebar"
					>
