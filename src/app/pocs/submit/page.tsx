						...
						<form className="space-y-6">
							...
							<div className="space-y-2">
								<div className="flex items-center justify-between">
									...
									<div className="flex gap-4">
										...
										<button className="text-[11px] text-slate-500 hover:text-primary" type="button">
											Preview
										</button>
									</div>
								</div>
							...
							<div className="space-y-2">
								...
								<div className="relative group">
									<pre className="bg-slate-900 text-slate-300 p-4 rounded-lg overflow-x-auto text-sm leading-relaxed min-h-50 border border-slate-800">
										<code>{`import socket
    ...
    pass`}</code>
					...
					<div className="xl:col-span-4 space-y-6">
							...
							<div className="p-4 space-y-4">
								...
								<div className="flex gap-3">
									...
									<div>
										...
										<p className="text-xs text-slate-500 mt-1 leading-normal">
											Plagiarism is strictly prohibited. Cite external researchers if applicable.
										</p>
									</div>
								</div>
								<div className="flex gap-3">
						...
						<div className="border border-slate-200 dark:border-slate-800 rounded-lg overflow-hidden bg-white dark:bg-slate-900/30">
							...
							<div className="p-4">
								<div className="relative pl-6 space-y-6 before:absolute before:left-2 before:top-2 before:bottom-2 before:w-px before:bg-slate-200 dark:before:bg-slate-700">
									<div className="relative">
										<div className="absolute -left-5 top-1 size-3 rounded-full bg-primary border-2 border-white dark:border-slate-900"></div>
									...
									<div className="relative">
										<div className="absolute -left-5 top-1 size-3 rounded-full bg-slate-300 dark:bg-slate-600 border-2 border-white dark:border-slate-900"></div>
										<p className="text-[13px] font-semibold text-slate-400">Sandbox Execution</p>
										<p className="text-[11px] text-slate-500">
